      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-in">
            <div className="bg-gradient-to-br from-devops-500/20 to-cloud-500/20 rounded-2xl p-8 mb-8">
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-2">Harish</h3>
          ...
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-2xl font-semibold mb-4">DevOps & Cloud Engineer</h3>
            <p className="text-muted-foreground leading-relaxed">
              I'm a passionate DevOps and Cloud Engineer with over 5 years of experience in designing, 
              implementing, and maintaining scalable infrastructure solutions. My expertise spans across 
              cloud platforms, containerization, automation, and monitoring.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              I specialize in helping organizations streamline their development workflows, improve 
              deployment reliability, and scale their infrastructure efficiently. From setting up 
              CI/CD pipelines to managing Kubernetes clusters, I enjoy solving complex infrastructure 
              challenges.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              ...
              <div className="bg-card border border-border rounded-lg p-4">
                <h4 className="font-semibold text-cloud-400 mb-2">Containerization</h4>
                <p className="text-sm text-muted-foreground">Docker, Kubernetes</p>
              </div>
              <div className="bg-card border border-border rounded-lg p-4">
                <h4 className="font-semibold text-devops-400 mb-2">Infrastructure</h4>
